                  ...
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      <div className="relative flex">
                        {/* <Popover Strategically used by some intelligence services: damaging, interfering, or altering information or information processes so as to cause confusion or doubt.  */}
